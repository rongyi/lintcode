// http://www.lintcode.com/zh-cn/problem/word-break-iii
#include <iostream>
#include <string>
...
public:
  ...
  * @param : A string
  * @param : A set of word
  * @return: there should no wordBreak3 problem, too shitty!
  */
  int wordBreak3(string &s, unordered_set<string> &dict) {
    auto ret = wordBreak(s, dict);
    return ret.size();
  }
  // copied from wordBreak
public:
...
int main() {
  unordered_set<string> dict{"me","mo","ry","mem","o","r","ca","Do"};
  string s{"memory"};
  Solution so;
  auto i = so.wordBreak3(s, dict);
  cout << i << endl;
  return 0;
}
